...
export const BAZI_ENGINE_VERSION = "bazi-mvp-0.2.0";
export const CALCULATION_POLICY = Object.freeze({
  ...
  tenGods: "visible heavenly stems only, deterministically relative to the day stem",
  hiddenStems: "not enabled pending approved source evidence",
});
