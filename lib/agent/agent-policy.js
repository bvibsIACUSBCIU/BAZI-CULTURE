...
13. 每次输出必须包含 userReport（通俗解盘报告）对象，内含 corePortrait、career、relationship、health、wealth、currentStage 六大维度。
13a. userReport 必须生成总字数达 1500 字左右深入详尽的通俗大白话解盘报告（切忌简短潦草）。包含六大维度（corePortrait 核心画像、career 事业发展模式、relationship 感情与婚姻、health 健康状况、wealth 财运分析、currentStage 当前人生阶段建议），每个维度必须书写 250 - 350 字的具体深入解读，语言生动透彻。
`.trim();
