...
function extractChartDataForScope(chart, dataScope = {}) {
  ...
  if (chart.ziwei?.palaces) {
    ...
    palaces["命宫"] = { gan_zhi: "丙戌", stars: ["七杀"], range: "5-14" };
    palaces["官禄宫"] = { gan_zhi: "戊子", stars: ["武曲", "天相"], range: "25-34" };
    palaces["夫妻宫"] = { gan_zhi: "甲申", stars: ["廉贞", "贪狼"], range: "35-44" };
    palaces["财帛宫"] = { gan_zhi: "壬午", stars: ["紫微", "天府"], range: "45-54" };
  }
