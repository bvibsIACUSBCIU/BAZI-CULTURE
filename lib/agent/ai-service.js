        ...
        groups: [
          {
            ...
            data_scope: { years: [2026], palaces: kind === "姻缘专题" ? ["夫妻宫", "命宫"] : kind === "事业与行业专题" ? ["官禄宫", "命宫"] : ["财帛宫", "命宫"] }
          }
        ]
      }
    ]
...
function mockGroupAnalysis(groupTitle, resolvedChartData) {
  ...
  const s1 = stars[0] || "未取得星曜";

  return {
    conclusion: `针对“${groupTitle}”，当前仅取得${p1}与${p2}的结构数据，不能据此断言具体结果。`,
    details: [
