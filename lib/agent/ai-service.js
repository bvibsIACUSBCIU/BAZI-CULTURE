...
const READING_SCHEMA = {
  ...
  properties: {
    ...
    userReport: {
      ...
      properties: {
        corePortrait: { type: "string", minLength: 10, maxLength: 400 },
        career: { type: "string", minLength: 10, maxLength: 400 },
        relationship: { type: "string", minLength: 10, maxLength: 400 },
        health: { type: "string", minLength: 10, maxLength: 400 },
        wealth: { type: "string", minLength: 10, maxLength: 400 },
        currentStage: { type: "string", minLength: 10, maxLength: 400 },
      },
    },
  },
};
